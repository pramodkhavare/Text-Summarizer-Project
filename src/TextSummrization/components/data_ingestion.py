...
class DataIngestion:
    ...
    def get_final_data(self):
        try:
            ...
            subdirectories = [subdir for subdir in os.listdir(text_summarization_data_repo_path) if os.path.isdir(os.path.join(text_summarization_data_repo_path, subdir))]
